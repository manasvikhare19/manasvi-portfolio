...
const projects: Project[] = [
  {
    ...
    body: 'A crop disease detector shaped around farmer discovery, classifying 57 diseases across 14 crops from roughly 93K images. Optimized via TFLite conversion (2800ms to 25ms inference speedup, 28MB to 2.6MB).',
  ...
  {
    num: '02',
    title: 'Caption / Generate',
    subtitle: 'Turning visual signals into language.',
    type: 'GENERATIVE AI',
    body: 'An image-captioning pipeline combining a vision encoder, language generation, prompt engineering, and scalable Vertex AI inference.',
    tags: ['Vertex AI', 'Prompting', 'Python', 'GCP'],
    metric: '03',
    label: 'systems in the pipeline',
    className: ''
  },
  {
    num: '03',
